...
from .semantic import extract_path_symbols
...
class TrackerService:
    ...
    def build_issue_context(self, workspace_id: str, issue_id: str) -> IssueContextPacket:
        return IssueContextPacket.model_validate(
            self._run_go_workspace_json("issue-context", workspace_id, ["--issue-id", issue_id])
        )
