# Historical architecture — before the September 2026 review

This is the previous architecture document, preserved for provenance. Its Python
ownership and planned-feature statements are historical. Read
[`../ARCHITECTURE.md`](../ARCHITECTURE.md) for the current implementation map.
