# Historical roadmap — June 2026 track split

This closed track list is preserved as history. Read
[`../ROADMAP.md`](../ROADMAP.md) for current priorities and open decisions.
